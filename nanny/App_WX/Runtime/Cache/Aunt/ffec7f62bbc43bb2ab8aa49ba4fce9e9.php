...
<link rel="stylesheet" type="text/css" href="/Public/aunt/static/h-ui.admin/skin/green/skin.css" id="skin" />
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml"><?php echo C('TITLE');?></a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml"></a> <span class="logo navbar-slogan f-l mr-10 hidden-xs"><?php echo C('VERSION');?></span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
			...
			<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
				<ul class="cl">
					<li><?php echo C('TITLE');?>-<?php echo session('aunt.name');?></li>
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A"> <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<!--<li><a href="#">个人信息</a></li>
							<li><a href="#">切换账户</a></li>-->
							<li><a href="<?php echo U('login/lay_out');?>">退出</a></li>
						</ul>
					</li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('user/aunt_list');?>" data-title="阿姨列表" href="javascript:void(0)">阿姨列表</a></li>
					<li><a data-href="<?php echo U('user/build_qrcode');?>" data-title="二维码" href="javascript:void(0)">二维码</a></li>
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="picture-list.html" data-title="用户统计" href="javascript:void(0)">用户统计</a></li>
				</ul>
			</dd>
		</dl>
		<!--<dl id="menu-product">
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="阿姨列表" data-href="<?php echo U('user/aunt_list');?>">阿姨列表</span><em></em></li>
			</ul>
		</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="<?php echo U('user/aunt_list');?>"></iframe>
		</div>
	</div>
</section>
...
<script type="text/javascript" src="/Public/aunt/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
