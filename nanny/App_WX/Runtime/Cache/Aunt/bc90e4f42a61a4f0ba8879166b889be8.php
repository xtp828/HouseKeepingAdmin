...
<![endif]-->
<link href="/Public/aunt/static/h-ui/css/H-ui.min.css" rel="stylesheet" type="text/css" />
<link href="/Public/aunt/static/h-ui.admin/css/H-ui.login.css" rel="stylesheet" type="text/css" />
<link href="/Public/aunt/static/h-ui.admin/css/style.css" rel="stylesheet" type="text/css" />
<link href="/Public/aunt/lib/Hui-iconfont/1.0.7/iconfont.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
...
<div class="footer">此版权归 <?php echo C('TITLE');?> 所有</div>
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3F080836300300be57b7f34f4b3e97d911' type='text/javascript'%3E%3C/script%3E"));
    ...
    function login(){
        ...
        $.ajax({
            url:"<?php echo U('login/submit_login');?>",
            type:'POST', //GET
            data:$('#fm').serialize(),
