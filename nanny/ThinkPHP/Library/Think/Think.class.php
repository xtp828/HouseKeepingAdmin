...
//        exit;
//        Colin Jiang 暂时修改 2016-08-09
//        C('LOG_PATH', realpath(LOG_PATH));
        //C('LOG_PATH', realpath(LOG_PATH) . '/' . MODULE_NAME . "/auth/");
        Log::write('>>>>> 错误信息：' . strip_tags($e['message']));
        Log::write('>>>>> 错误位置：' . $e['file'] . ' 行：' . $e['line']);
        $data = array('status'=>'10001');
